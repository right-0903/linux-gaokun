...
| Touchscreen over spi | partial | see [below](#over-spi) |
| TPM | x | |
| USB | works | |
...
#### algorithm
Due to the limitation of algorithm, the active windows is only central area $A$.

$$
A = \\{ (x, y) | (x, y) \in (20.\dot{3}, 2537.\dot{3}) \times (19, 1579) \\}.
$$
